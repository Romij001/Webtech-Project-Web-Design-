...
if($_POST){
	...
	// }
	// $sql = "UPDATE `candidates` SET `FirstName`='$fname',`LastName`='$lname',`Address`='$address',`Gender`='$gender',`Email`='$email',`Status`='$status' WHERE `CandidateID` = '$id'";
	// //echo $sql;
	// $update = mysqli_query($conn, $sql);

	$update = CEdit($id, $fname, $lname, $address, $gender, $email);

...
<html>
  <head>
    <title></title>
    <script src="JS Files/CandidateEdit.js"></script>
  ...
  <body>    
    <div class="SU_form">
      ...
      <form method="post" action="../Controller/CEditValidation.php" novalidate onsubmit="return CandidateEdit_valid(this)";>
      <?php
      ...
      mysqli_stmt_prepare($stmt, "SELECT * FROM `candidates` WHERE CandidateID = ?");
      ...
      if ($rows_count > 0) {
        ...
        $status = $row['Status'];
      ?>
      <input type="hidden" name="id" value="<?php echo $candidateId ?>" />
      ...
      <a href="Candidates.php"><input type="button" value="Back"></a>
      </form>
    </div>
  </body>
</html>

...
<html>
  <head>
    <title></title>
    <script src="JS Files/VoterEdit.js"></script>
    <link rel="stylesheet" href="../CSS/Style.css">
  </head>
  <body>    
    <div class="SU_form">
      <h2>Voter Profile Edit</h2>
      ...
      <form method="post" action="../Controller/VEditValidation.php" novalidate onsubmit="return VoterEdit_valid(this)";>
      <?php
      ...
      mysqli_stmt_prepare($stmt, "SELECT * FROM `Voters` WHERE VoterID = ?");
      ...
      if ($rows_count > 0) {
        ...
        $status = $row['Status'];
      ?>
      <input type="hidden" name="id" value="<?php echo $voterId ?>" />
      ...
      <a href="Voters.php"><input type="button" value="Back"></a>
      </form>
    </div>
  </body>
</html>
